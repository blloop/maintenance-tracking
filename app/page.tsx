    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-gray-800 text-white p-4">
        <div className="container mx-auto">
          <h1 className="text-2xl font-bold">MyMaintenance</h1>
        </div>
      </header>
      <main className="container mx-auto p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-2 rounded-lg border shadow-sm bg-slate-50 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-lg border shadow-sm bg-slate-50 space-y-4 p-6">
            <h3 className="text-2xl font-semibold leading-none tracking-tight">
              Recent Records
            </h3>
            <ul className="space-y-4 tracking-tight">
